...
class Config(ClassDict):
    ...
    """
    def __init__(self, p_net_setting_path, v_sim_setting_path, **kwargs):
        self.p_net_setting_path = p_net_setting_path
        self.v_sim_setting_path = v_sim_setting_path
        ### Dataset ###
    ...
    def read_settings(self, p_net=True, v_sim=True):
        ...
        if p_net:
            print(f'Load p_net_setting from {self.p_net_setting_path}') if self.verbose > 0 else None
...
def update_simulation_setting(
        ...
        v_sim_setting_node_resource_attrs_high: int = None,
        v_sim_setting_node_resource_attrs_low: int = None,
        v_sim_setting_link_resource_attrs_high: int = None,
        v_sim_setting_link_resource_attrs_low: int = None,
    ...
    for i in range(len(config.v_sim_setting['node_attrs_setting'])):
        if config.v_sim_setting['node_attrs_setting'][i]['type'] == 'resource':
            config.v_sim_setting['node_attrs_setting'][i]['high'] = v_sim_setting_node_resource_attrs_high \
                if v_sim_setting_node_resource_attrs_high is not None else config.v_sim_setting['node_attrs_setting'][i]['high']
            config.v_sim_setting['node_attrs_setting'][i]['low'] = v_sim_setting_node_resource_attrs_low \
                if v_sim_setting_node_resource_attrs_low is not None else config.v_sim_setting['node_attrs_setting'][i]['low']
    for i in range(len(config.v_sim_setting['link_attrs_setting'])):
        if config.v_sim_setting['link_attrs_setting'][i]['type'] == 'resource':
            config.v_sim_setting['link_attrs_setting'][i]['high'] = v_sim_setting_link_resource_attrs_high \
                if v_sim_setting_link_resource_attrs_high is not None else config.v_sim_setting['link_attrs_setting'][i]['high']
            config.v_sim_setting['link_attrs_setting'][i]['low'] = v_sim_setting_link_resource_attrs_low \
                if v_sim_setting_link_resource_attrs_low is not None else config.v_sim_setting['link_attrs_setting'][i]['low']
